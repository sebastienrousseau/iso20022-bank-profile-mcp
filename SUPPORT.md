...
How to get help with `iso20022-bank-profile-mcp`, organised by need.

## I want to ask a question

Use **[GitHub Discussions](https://github.com/sebastienrousseau/iso20022-bank-profile-mcp/discussions)**.
...
File a **[GitHub Issue](https://github.com/sebastienrousseau/iso20022-bank-profile-mcp/issues/new)**.
Helpful minimum: which MCP client you're using (Claude Desktop, IDE,
custom), the tool that's misbehaving (`list_profiles`, `get_profile`,
`lint_payload`, `validate_profile_definition`), the input you sent (the
payload or profile-definition text and the target profile), and the output
you got. A minimal reproducer turns a 2-week investigation into a 2-hour fix.

## I want to request a feature

Also a **[GitHub Issue](https://github.com/sebastienrousseau/iso20022-bank-profile-mcp/issues/new)** —
...
- **Preferred**: [GitHub Security Advisories](https://github.com/sebastienrousseau/iso20022-bank-profile-mcp/security/advisories/new)
  (private + tracked).
- **Alternative**: email
...
Not formally offered today. The higher-tier, bank-specific proprietary rule
packs are on the [roadmap](ROADMAP.md) as paid add-ons; for ad-hoc consulting /
integration help, contact
[sebastian.rousseau@gmail.com](mailto:sebastian.rousseau@gmail.com).
