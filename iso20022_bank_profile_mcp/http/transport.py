...
``ISO20022_BANK_PROFILE_OAUTH_*`` variables are set, see
:mod:`~iso20022_bank_profile_mcp.http.oauth`), or a static dev-mode bearer
...
from iso20022_bank_profile_mcp.http import oauth as _oauth
...
TOKEN_ENV = "ISO20022_BANK_PROFILE_TOKEN"  # nosec B105
...
def run_http(mcp_server: FastMCP, bind: str, token: str | None = None) -> None:
    ...
    environment, strongest first: OAuth 2.1 (when ``ISO20022_BANK_PROFILE_OAUTH_*``
